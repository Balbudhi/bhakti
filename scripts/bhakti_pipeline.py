...
<head>
  ...
  <link rel="stylesheet" href="../../assets/song.css?v=contract-20260821-10" />
</head>
<body>
  <main class="song-page">
    <header class="song-hero">
      <div class="song-top-controls" aria-label="Song controls">
        <button class="song-sync" id="songSync" type="button" aria-label="Keep lyrics synced to playback" aria-pressed="true" title="Lyrics follow playback"><svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true"><g class="chain-linked"><path d="m10.6 13.4 2.8-2.8M7.7 16.3l-1.4 1.4a3.25 3.25 0 0 1-4.6-4.6l4-4a3.25 3.25 0 0 1 4.6 0M16.3 7.7l1.4-1.4a3.25 3.25 0 0 1 4.6 4.6l-4 4a3.25 3.25 0 0 1-4.6 0" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></g><g class="chain-unlinked"><path d="m8.8 10.2-1.4-1.4a3.25 3.25 0 0 0-4.6 4.6l1.8 1.8a3.25 3.25 0 0 0 4.6 0l1.3-1.3M15.2 13.8l1.4 1.4a3.25 3.25 0 0 0 4.6-4.6l-1.8-1.8a3.25 3.25 0 0 0-4.6 0l-1.3 1.3" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></g></svg></button>
...
{meta_html}      <p class="song-hint">Tap or hover over any word to see its meaning.</p>
  ...
  <script src="../../assets/song.js?v=contract-20260821-9"></script>

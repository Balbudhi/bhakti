  ...
  <main class="song-page">
    <header class="song-hero">
      <div class="song-top-controls" aria-label="Song controls">
        <button class="song-sync" id="songSync" type="button" aria-label="Keep lyrics synced to playback" aria-pressed="true" title="Lyrics follow playback"><svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true"><g class="chain-linked"><path d="M9 17H7A5 5 0 0 1 7 7h2"/><path d="M15 7h2a5 5 0 1 1 0 10h-2"/><path d="M8 12h8"/></g><g class="chain-unlinked"><path d="M15 7h2a5 5 0 0 1 0 10h-2m-6 0H7A5 5 0 0 1 7 7h2"/></g></svg></button>

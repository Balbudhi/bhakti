  ...
  <main class="song-page">
    <header class="song-hero">
      <div class="song-top-controls" aria-label="Song controls">
        <button class="song-sync" id="songSync" type="button" aria-label="Keep lyrics synced to playback" aria-pressed="true" title="Lyrics follow playback"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><g class="chain-linked"><path d="m10.6 13.4 2.8-2.8"/><path d="M7.7 16.3l-1.4 1.4a3.25 3.25 0 0 1-4.6-4.6l4-4a3.25 3.25 0 0 1 4.6 0"/><path d="M16.3 7.7l1.4-1.4a3.25 3.25 0 0 1 4.6 4.6l-4 4a3.25 3.25 0 0 1-4.6 0"/></g><g class="chain-unlinked"><path d="m8.8 10.2-1.4-1.4a3.25 3.25 0 0 0-4.6 4.6l1.8 1.8a3.25 3.25 0 0 0 4.6 0l1.3-1.3"/><path d="M15.2 13.8l1.4 1.4a3.25 3.25 0 0 0 4.6-4.6l-1.8-1.8a3.25 3.25 0 0 0-4.6 0l-1.3 1.3"/></g></svg></button>
